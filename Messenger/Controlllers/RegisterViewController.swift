...
class RegisterViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        imageView.frame = CGRect(x: (scrollView.width - size)/2 , y: 10 , width: size, height: size)
        imageView.layer.cornerRadius = imageView.width/2.0
        firstNameField.frame = CGRect(x: 30, y: imageView.bottom+140, width: scrollView.width-60 , height: 40)
        lastNameField.frame = CGRect(x: 30, y: firstNameField.bottom+45, width: scrollView.width-60 , height: 40)
        emailField.frame = CGRect(x: 30, y: lastNameField.bottom+45, width: scrollView.width-60 , height: 40)
